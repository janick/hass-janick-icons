const JANICK_ICONS_MAP = {
  "rowing-machine":
       "M229.241,170.738C229.241,110.78,278.021,62,337.98,62c5.247,0,9.5,4.253,9.5,9.5s-4.253,9.5-9.5,9.5
...
async function getIcon(name) {
  return { path: JANICK_ICONS_MAP[name] };
}

let janick_icons_mode = 'modern';
window.customIconsets = window.customIconsets || {};
window.customIconsets["janick"] = getIcon;

// prepare for picker style
async function getIconList() {
  return Object.keys(JANICK_ICONS_MAP).map(icon => ({name: icon}));
}
